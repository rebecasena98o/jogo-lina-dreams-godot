...
var idx_conversa = 0
var opcoes_respostas = [2, 0, 1, 0, 2]
...
func get_falas(idx: int):
	var opcoes_falas = [
		[
			"Beleza então! Se vira feioso!", # Errada
			"Credo, Saí bicho grosso!", # Errada
			"Nosso! Como você é orgulhoso! E grosseiro! Você não tem amigos?" # Certa
		],
		[
...
func _on_animation_player_animation_finished(anim_name: StringName) -> void:
	get_tree().change_scene_to_file("res://Arquivos/Scenes/Level3/level_3.tscn")
